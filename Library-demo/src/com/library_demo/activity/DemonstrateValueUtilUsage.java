 ...
 * @version 创建时间：2014-10-26 上午11:06:43 类说明
 */
...
public class DemonstrateValueUtilUsage extends Activity {
  ...
  public void getValueWithoutDecimal(View v) {
    valueWithoutDecimal
        .setText(ValueUtil.getValueWithoutDecimal(valueDecimal.getText().toString()));
  }

  public void getValueWithTwoDecimal(View v) {
    valueWithTwoDecimal.setText(ValueUtil.getValueWithTwoDigit(valueMoreDecimal.getText()
        .toString()));
  }
}
